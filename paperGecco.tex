...
\usepackage{url}
\urldef{\mailsa}\path|{mgarenas,nrico,deromero,pacv,jmerelo}@ugr.es|
...
Nuria Rico\titlenote{Dr.~Nuria Rico Castro.}\\
       \affaddr{Faculty of Science University of Granada}\\
       \email{nrico@ugr.es}
% 2nd. author
\alignauthor
M.G. Arenas\titlenote{Dr. ~ M. Isabel García Arenas.}\\
       \affaddr{ETSIIT - University of Granada}\\
       \email{mgarenas@ugr.es}
% 3rd. author
\alignauthor
D. Romero\titlenote{Dr. ~Desirée Romero.}\\
       \affaddr{ETSIIT - University of Granada}\\
       \email{deromero@ugr.es}
\alignauthor
P. A. Castillo\titlenote{Dr. ~Pedro A. Castillo Valdivieso.}\\
       \affaddr{ETSIIT - University of Granada}\\
       \email{pacv@ugr.es}
\alignauthor
J. M. Crespo\titlenote{Dr. ~J. M. Crespo.}\\
       \affaddr{ETSIIT - University of Granada}\\
       \email{crespo@ugr.es}
%\and  % use '\and' if you need 'another row' of author names
% 4th. author
\alignauthor J. J. Merelo\\
       \affaddr{Dr. Juan Julián Merelo Guervós}\\
       \affaddr{ETSIIT-University of Granada}\\
       \email{jjmerelo@ugr.es}
}
...
Evolving Multilayer Perceptrons, Neural Processing Letters, vol. 12, no. 2, pp. 115--127, 2000.

\bibitem{GPropII}
S. Fahlman:
Faster-learning variations on back-propagation: An empirical study, in Proceedings of the 1988 Connection- ist models summer school. M. Kaufmann, 1988, pp. 38--51.
