...
\title{Comparing some optimization methods to obtain estimations in the Gompertz-lognormal diffusion process}
% a short form should be given in case it is too long for the running head
\titlerunning{Comparing optimization methods to obtain estimations}
...
\begin{figure}
  \centering
\begin{tabular}{ c c }
  \epsfig{file=./Graficas/graf1prueba.eps,width=.50\textwidth} & \epsfig{file=./Graficas/graf2prueba.eps,width=.50\textwidth} \\
  $\sigma^2=10^{-5}$ & $\sigma^2=10^{-4}$ \\
  \epsfig{file=./Graficas/graf3prueba.eps,width=.50\textwidth} & \epsfig{file=./Graficas/graf4prueba.eps,width=.50\textwidth} \\
